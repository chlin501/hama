...
public final class SingleLockQueue<T> implements SynchronizedQueue<T> {
  ...
  public Configuration getConf() {
    synchronized (mutex) {
      return (HamaConfiguration)queue.getConf();
    }
  }

  /**
   * (non-Javadoc)
   * @see org.apache.hama.bsp.message.SynchronizedQueue#init(
   *      org.apache.hama.HamaConfiguration, org.apache.hama.bsp.TaskAttemptID)
   */
  @Override
