...
public interface SyncClient {
   ...
   */
  String constructKey(BSPJobID jobId, String... args);
   ...
   */
  boolean storeInformation(String key, Writable value, boolean permanent, 
   ...
   */
  boolean getInformation(String key, Writable valueHolder);
   ...
   */
  boolean addKey(String key, boolean permanent, SyncEventListener listener);
   ...
   */
  String[] getChildKeySet(String key, SyncEventListener listener);
   ...
   */
  boolean registerListener(String key, SyncEvent event,
                           SyncEventListener listener);
   ...
   * @return
   */
  boolean remove(String key, SyncEventListener listener);
